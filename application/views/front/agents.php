                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-3 sidebar-right">
                            <?php 
                            $data['limit_number']=6;
                            $this->load->view('widgets/agents_search_sidebar',$data);?>
                        </div>
...
function load_contents(track_page){
    if(loading == false){
		...
		$.post( '<?php echo base_url()."more_agents_searh_result";?>', {'page': track_page,'city':'<?php echo $region_id;?>'}, function(data){
